  ...
  return (
    <div className="mx-auto max-w-lg space-y-8 p-6">
      <header className="text-center">
        <h1 className="text-3xl font-bold text-cyan-400">ScrollShield</h1>
      ...
      <div className="rounded-2xl bg-slate-800/80 p-6">
        <h2 className="text-sm font-medium text-slate-400">Daily Focus Score</h2>
        <p className="mt-1 text-4xl font-bold text-cyan-400">{focusScore}</p>
      ...
      <div className="rounded-2xl bg-slate-800/80 p-6">
        <h2 className="mb-4 text-sm font-medium text-slate-400">Achievements</h2>
  ...
  return (
    <li
      className={`flex items-center gap-3 rounded-xl px-3 py-2 ${
        unlocked ? 'bg-cyan-400/10 text-cyan-400' : 'bg-slate-800/60 text-slate-500'
      }`}
    >
